  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        ...
        */
                        _searchMealList = MealsList.where((element) =>
                        ...
                        print('$isGluton $isLuctose $isVegan');

                        _searchMealList = _searchMealList
                            .where((element) =>
                                element.isGluton == isGluton &&
                                element.isLuctose == isLuctose &&
                                element.isVegan == isVegan)
                            .toList();
                      });
                    },
                  ),
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.of(context)
                              .pushNamed('/meal-detail', arguments: meal.id);
                        },
                        borderRadius: BorderRadius.circular(8),
                        child: Container(
